...
return [
    'modules' => [
        ...
        'BaseAutoSound_Currencies' => 1,
        'BaseAutoSound_FooterAutotem' => 1,
        'BaseAutoSound_FormReviews' => 1,
        'BaseAutoSound_HeaderAutotem' => 1,
        'BaseAutoSound_Languages' => 1,
        'BaseAutoSound_Memories' => 1,
        'BaseAutoSound_Readmore' => 1,
        'BaseAutoSound_ViewedProducts' => 1,
