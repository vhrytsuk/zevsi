    ...
    function ($) {
        ...
        $.widget('memories.customerJs', {
            options: {
                ...
                titleTableRating : 'Рейтинг гривців',
            ...
            _createCart: function () {        //створює картки
                var arr = this.options.numberCells,
            ...
            _createTable: function () {
                var bestPlayers = this._clearArrExcess(),
                    ...
                    caption = this._createElem('caption', {}, this.options.titleTableRating),
                ...
                for (var key in bestPlayers) {    //створюємо таблицю з багатовимірного масива
                    for (var key2 in bestPlayers[key]) {
                        ...
                        if (playerPlace >= 3) {            // роблю 1,2,3 місце для кожного рівня
                            playerPlace = 0;
                        }
                        playerPlace++;
            ...
            _sortTable: function () {  //відсортовуємо масив по рівням та по кількості ходів
                ...
                if (localstorageRatingData) {
                    return localstorageRatingData.sort((a, b) => a.moves < b.moves ? 1 : -1).sort((a, b) => a.level > b.level ? 1 : -1);
                }
            },

            _clearTable: function (e) {        //очистить таблицю
